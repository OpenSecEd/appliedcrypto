...
\mode<all>{\includepdf[pages=10-24]{./dog-hash-tilkry24.pdf}}

\begin{frame}
  \begin{remark}
    \begin{itemize}
      \item We can prove similar results for second-preimage and collision 
        resistance.
      \item Collision resistance implies the other two.
    \end{itemize}
  \end{remark}
\end{frame}
...
\mode<all>{\includepdf[pages=29-39]{./dog-hash-tilkry24.pdf}}
