...
\begin{frame}
  ...
  \begin{remark}[Semantic Security of ElGamal]
    \begin{itemize}
      \item The ElGamal encryption scheme offers semantic security under the 
        assumption that the \ac{DDH} problem is hard.
    \end{itemize}
  \end{remark}
\end{frame}
...
\section{Public-key infrasturctures, PKIs}
