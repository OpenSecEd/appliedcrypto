  ...
  \begin{frame}
    ...
    \begin{block}{Organization}
      \begin{itemize}
        ...
        \item Pick one of the three functionalities.
        \item \alert<2>{Design a solution: detail the crypto protocol.}
        \item Document at \url{https://tinyurl.com/tilkry25-postbox}
    ...
    \begin{block}{Organization}
      \begin{itemize}
        ...
        \item Work for 20 minutes, document: 
          \url{https://tinyurl.com/tilkry25-anon-postbox}.
        \item Group presentations and discussions.
      \end{itemize}
    \end{block}
  \end{frame}
...
\begin{frame}
  \begin{exercise}
    \begin{itemize}
      ...
      \item Document: \url{https://tinyurl.com/tilkry25-identity}.
    \end{itemize}
  \end{exercise}
\end{frame}
