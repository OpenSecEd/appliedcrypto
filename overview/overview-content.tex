...
\begin{frame}
  \begin{example}[Age limits]
    \begin{itemize}
      \item We want to go see a film in cinema.
      \item We look very young so they want to have proof of our age.

        \pause{}

      \item Show physical ID, reveals exact date of birth.
    \end{itemize}
  \end{example}
  ...
  \begin{exercise}
    \begin{itemize}
      \item That's a bit unnecessary, right?
      \item What do they actually only need to know?
